...
- `FROM`: specify the table to fetch from
- `LEFT JOIN`: perform a join operation to merge two tables on a common column
- `WHERE`: get the data that satisfies these conditions
...
- `plotly`: This package will be our main visualization tool.
- `pyplot`: This package is required to perform necessary formattinng.
